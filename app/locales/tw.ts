...
const tw: LocaleType = {
  ...
  Store: {
    ...
    Prompt: {
      ...
      Topic: "Generate a conversation title in the language of the user's first message, concisely capturing the essence of the main topic discussed in the initial exchange between the user and you. Use no more than 10 tokens, do not use quotation marks, and do not include any translations or content in brackets.",
      Summarize:
        "Summarize the conversation you and the user, capturing the key points and main topics discussed. Ensure the summary does not exceed 250 tokens in length.",
    },
